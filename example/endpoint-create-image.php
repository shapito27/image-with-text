...
$result = $imageGenerator
    ...
    ->setText($_POST['text'])
    ->setCoefficientLeftRightTextPadding($_POST['text-coefficient-left-right'])
    ->setTextLinesTopBottomPadding($_POST['text-coefficient-top-bottom'])
    ->setImageQuality($_POST['image-quality'])
    ->generate();
